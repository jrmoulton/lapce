...
ASSETS_DIR = extra
RELEASE_DIR = /Users/jaredmoulton/.cargo/target/release-lto
...
$(TARGET)-native:
	...
	@lipo /Users/jaredmoulton/.cargo/target/release-lto/$(TARGET) -create -output $(APP_BINARY)
$(TARGET)-universal:
	...
	@lipo /Users/jaredmoulton/.cargo/target/{x86_64,aarch64}-apple-darwin/release-lto/$(TARGET) -create -output $(APP_BINARY)
